...
if __name__ == "__main__":
    vm = VM(hostname="10.4.41.51", password="bdm")
    ...
    print("")
    transfer_source_files(vm, "data/data.zip", f"{root_directory}/data.zip")
    ...
    print("")
    delete_file_in_dir(vm, f'{root_directory}/data.zip')

    files = get_files_in_folder(vm, f'{root_directory}/data')
